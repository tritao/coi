...
int main(int argc, char **argv)
{
    ...
    try
    {
        ...
        if (is_web_target)
        {
            ...
            out << "            else if (_coi_sv_eq(t, \"clip\") || _coi_sv_eq(t, \"clip-x\") || _coi_sv_eq(t, \"clip-y\")) { has_clip = true; }\n";
            out << "            else if (_coi_sv_eq(t, \"scroll\")) { has_clip = true; scroll_x = true; scroll_y = true; }\n";
            out << "            else if (_coi_sv_eq(t, \"scroll-y\")) { has_clip = true; scroll_y = true; }\n";
            out << "            else if (_coi_sv_eq(t, \"scroll-x\")) { has_clip = true; scroll_x = true; }\n";
            ...
            out << "        // Clip/scroll\n";
            out << "        if (has_clip) {\n";
            out << "            if (scroll_x) { st += \"overflow-x:auto;\"; } else { st += \"overflow-x:hidden;\"; }\n";
            out << "            if (scroll_y) { st += \"overflow-y:auto;\"; } else { st += \"overflow-y:hidden;\"; }\n";
            out << "        }\n";
            out << "\n";
            out << "        // Text\n";
